...
description: "The MastraServer abstract class is the base for all server adapters. Extend this class to create adapters for frameworks other than Hono or Express."
packages:
  - "@mastra/core"
  - "@mastra/server"
---
