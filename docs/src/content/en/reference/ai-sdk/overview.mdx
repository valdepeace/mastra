...
description: "Wrap Vercel AI SDK models with Mastra processors and memory using withMastra(), while retaining existing AI SDK generation, streaming, and UI integrations."
packages:
  - "@mastra/ai-sdk"
  - "@mastra/core"
  - "@mastra/libsql"
