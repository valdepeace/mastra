...
description: "Use MastraAuthOkta and MastraRBACOkta to authenticate users with Okta and enforce role-based access control for Mastra application resources."
packages:
  - "@mastra/auth-okta"
  - "@mastra/core"
---
