...
description: "Configure LangfuseExporter to send Mastra traces to Langfuse with credentials, custom endpoints, batching, environments, releases, and client access."
packages:
  - "@mastra/langfuse"
