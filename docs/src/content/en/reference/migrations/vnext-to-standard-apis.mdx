...
description: "Migrate from VNext methods to Mastra's standard agent generation and streaming APIs, including renamed options, result types, and compatibility changes."
packages:
  - "@mastra/core"
---
