...
description: "Use createSummarizationScorer() to evaluate whether a summary is supported by its source text and preserves the source's important information."
packages:
  - "@mastra/core"
  - "@mastra/evals"
---
