...
description: "The createContextRecallScorer() function creates a scorer that evaluates how well retrieved context covers the claims in a ground-truth reference answer."
packages:
  - "@mastra/core"
  - "@mastra/evals"
---
