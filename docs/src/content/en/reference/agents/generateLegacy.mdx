...
description: "The .generateLegacy() method is the legacy version of the agent generation API, used with legacy model adapters to produce text or structured responses."
packages:
  - "@mastra/core"
---
