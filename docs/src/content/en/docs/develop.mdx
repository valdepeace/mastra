...
description: "Develop and test Mastra agents locally with mastra dev, Studio, file-based agents, the Mastra CLI, and AI coding tools that understand your project."
packages:
  - "@mastra/core"
---
