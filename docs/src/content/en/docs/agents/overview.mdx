---
title: "Agents"
description: "Build Mastra agents that use LLMs, tools, memory, workflows, and subagents to reason through open-ended tasks and return structured or streamed responses."
packages:
  - "@mastra/core"
---
