...
<Steps>
  ...
  <StepItem>
    Select **Create project**. The platform creates the repository with a `.mastra-project.json` config file, provisions its managed databases, then triggers the initial Studio and Server deploys.
  </StepItem>
</Steps>
