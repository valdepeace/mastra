...
description: "Collect and query hosted traces, logs, metrics, scores, and feedback from Mastra applications with Mastra Platform Observability and local fallback storage."
packages:
  - "@mastra/core"
