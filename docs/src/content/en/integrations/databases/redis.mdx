...
description: "Store Mastra application data in Redis using connection strings, host settings, or custom clients, including Sentinel and Cluster deployments."
packages:
  - "@mastra/core"
  - "@mastra/memory"
  - "@mastra/redis"
