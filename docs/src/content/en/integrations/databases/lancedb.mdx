...
description: "Use LanceDB for Mastra application storage and vector operations, configure tables and initialization, and account for its observability limitations."
packages:
  - "@mastra/core"
  - "@mastra/lance"
---
