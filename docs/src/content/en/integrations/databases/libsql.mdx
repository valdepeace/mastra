...
description: "Persist Mastra messages, workflow snapshots, traces, and eval scores in local or remote libSQL with managed tables and initialization options."
packages:
  - "@mastra/core"
  - "@mastra/libsql"
  - "@mastra/memory"
