...
description: "Store Mastra observability data and metrics in embedded DuckDB for local analytics, either standalone or as a specialized composite storage domain."
packages:
  - "@mastra/duckdb"
  - "@mastra/core"
---
