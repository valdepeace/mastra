...
description: "Store Mastra application data in Amazon Aurora DSQL with IAM authentication, configurable credentials, schema initialization, and connection options."
packages:
  - "@mastra/core"
  - "@mastra/dsql"
  - "@mastra/memory"
