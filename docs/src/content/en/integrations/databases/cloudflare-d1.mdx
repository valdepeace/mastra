...
description: "Persist Mastra data in Cloudflare D1 with serverless SQL storage, Worker bindings or REST access, schema initialization, and Cloudflare deployment."
packages:
