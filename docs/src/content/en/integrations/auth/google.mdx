---
title: "Google | Auth"
description: "Secure Mastra APIs and Studio with Google Workspace OAuth, encrypted sessions, hosted-domain checks, group-based RBAC, and client authentication."
packages:
  - "@mastra/auth-google"
---
