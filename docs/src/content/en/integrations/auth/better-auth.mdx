...
description: "Secure a Mastra server with a self-hosted Better Auth instance, configure route authorization, and authenticate clients with cookies or bearer tokens."
packages:
