...
description: "Store Mastra workspace files in a Google Drive folder with service-account authentication, POSIX paths, directory mapping, and read-only mode."
packages:
  - "@mastra/google-drive"
---
