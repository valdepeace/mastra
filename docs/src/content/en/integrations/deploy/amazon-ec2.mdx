...
description: "Deploy a Mastra server to Amazon EC2 with managed infrastructure for long-running agents and workflows, environment configuration, and public access."
---
