...
description: "Deploy a containerized Mastra agent to Amazon Bedrock AgentCore Runtime with the AgentCore CLI, AWS CodeBuild, configuration, and endpoint verification."
---
