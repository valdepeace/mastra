...
description: "Deploy a containerized Mastra server to AWS Lambda with the Lambda Web Adapter, configure runtime settings, and verify the serverless endpoint."
---
