...
description: "Connect CopilotKit to Mastra through AG-UI for generative UI, shared application state, frontend tools, human approval, and messaging channels."
packages:
  - '@mastra/core'
---
