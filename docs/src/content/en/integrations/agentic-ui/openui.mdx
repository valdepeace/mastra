...
description: "Stream Mastra agent output into OpenUI through AG-UI, render generative interfaces with built-in components, and customize the component library."
packages:
  - '@mastra/core'
---
