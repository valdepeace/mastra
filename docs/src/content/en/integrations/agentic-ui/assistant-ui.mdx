...
description: "Integrate Assistant UI with Mastra to build a polished React chat interface backed by Mastra agents, streaming responses, and tool interactions."
packages:
  - '@mastra/core'
---
