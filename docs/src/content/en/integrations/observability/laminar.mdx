...
description: "Export Mastra traces to Laminar for OpenTelemetry-native agent observability, debugging, and monitoring with endpoint and API key configuration."
packages:
  - "@mastra/laminar"
