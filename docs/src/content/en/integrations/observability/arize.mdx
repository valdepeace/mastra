...
description: "Export Mastra traces to Arize Phoenix or Arize AX for AI observability and evaluation, with project, endpoint, API key, and environment configuration."
packages:
  - "@mastra/arize"
