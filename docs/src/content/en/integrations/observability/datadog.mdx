...
description: "Send Mastra traces to Datadog LLM Observability with exporter configuration, span type mapping, agent and workflow naming, and serverless flushing."
packages:
