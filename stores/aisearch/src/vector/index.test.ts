...
describe('AzureAISearchVector Unit Tests', () => {
  ...
  describe('deleteVector', () => {
    ...
    it('should delete vector successfully', async () => {
      ...
      expect(mockSearchClientInstance.deleteDocuments).toHaveBeenCalledWith([
        { id: 'doc1' },
      ]);
    });
...
const describeIntegration = AZURE_AI_SEARCH_ENDPOINT && AZURE_AI_SEARCH_CREDENTIAL 
  ? describe 
  : describe.skip;
